             ...
             >
              ...
              <Form className="flex flex-col h-100 w-96 bg-white rounded-lg p-6 shadow-lg">
                  ...
                  <div className="flex flex-col items-start mx-auto mt-5">
                      ...
                      <Field name="confirmPassword" type="password" className="border rounded-lg bg-slate-200 w-60 p-1"/>
                      <ErrorMessage
                      component="span"
                      name="confirmPasword"
                      className="text-red-500"
                  ...
                  <p className="text-slate-400 mt-2 flex justify-center text-sm"><a className="underline px-1 cursor-pointer hover:text-gray-800" href="/">Sign in</a></p>
                  </div>
              </Form>
              </Formik>
          </div>
